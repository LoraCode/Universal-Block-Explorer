...
bitcoin = Asset.create!(name: 'Bitcoin')
ripple = Asset.create!(name: 'Ripple')
ethereum = Asset.create!(name: 'Ethereum')
stellar = Asset.create!(name: 'Stellar')

currency.assets << [bitcoin, ripple]
platform.assets << [ethereum, stellar]
